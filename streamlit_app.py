...
menu = st.tabs(["세븐틴 소개", "세븐틴 퀴즈"])
intro_tab, quiz_tab = menu

with intro_tab:
    st.write("세븐틴은 13명의 멤버로 이루어진 한국의 보이 그룹입니다.")
    st.write("짧은 시간 안에 많은 팬들을 사로잡은 강한 퍼포먼스와 다양한 음악으로 사랑받고 있습니다.")
    st.write("멤버들은 각자 개성 있는 매력을 가지고 있으며, 앨범과 공연을 통해 꾸준히 활약하고 있습니다.")
